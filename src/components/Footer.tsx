...
import { Fuel, Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl text-white">Fuel<span className="text-brand-red">&Wheels</span></span>
            </div>
            <p className="text-gray-400 mb-6">
              We bring fuel & basic car care services right to your doorstep, saving you time and hassle.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@fuelandwheels.com</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/fuel" className="text-gray-400 hover:text-brand-red transition-colors">
                  Fuel Delivery
                </Link>
              </li>
              <li>
                <Link to="/service" className="text-gray-400 hover:text-brand-red transition-colors">
                  Car Servicing
                </Link>
              </li>
              <li>
                <Link to="/subscription" className="text-gray-400 hover:text-brand-red transition-colors">
                  Subscription Plans
                </Link>
              </li>
              <li>
                <Link to="/track" className="text-gray-400 hover:text-brand-red transition-colors">
                  Track My Order
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form className="space-y-3">
              ...
              <button 
                type="submit" 
                className="w-full bg-brand-red hover:bg-red-700 text-white py-2 rounded transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Fuel&Wheels. All rights reserved.
          </p>
